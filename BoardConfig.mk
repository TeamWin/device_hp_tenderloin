...
TARGET_PREBUILT_KERNEL := device/hp/tenderloin/prebuilt/boot/recovery-kernel
TARGET_PREBUILT_RECOVERY_KERNEL := device/hp/tenderloin/prebuilt/boot/recovery-kernel
